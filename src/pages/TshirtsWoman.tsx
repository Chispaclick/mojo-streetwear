...
export const TshirtsWoman = () => {
    ...
    return (
        <main className="w-full">
            ...
            {/* HERO */}
            <section className="relative flex min-h-[100vh] items-center bg-[url('/../images/t-shirts-woman/hero-hoodies-woman-1.png')] bg-cover bg-top">
